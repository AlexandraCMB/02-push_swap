...
/*   Updated: 2026/05/07 22:16:54 by brunj            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    if((operation->num == RA && operation->next->num == RB) || (operation->num == RB && operation->next->num == RA))
        return 1;
    if((operation->num == RRA && operation->next->num == RRB) ||(operation->num == RRB && operation->next->num == RRA) )
        return 2;
    return 0;
